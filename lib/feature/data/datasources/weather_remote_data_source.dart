...
class WeatherRemoteDataSourceImpl implements WeatherRemoteDataSource {
  ...
  Future<List<WeatherModel>> getDailyWeather(String lat, String long) =>
      _getWeathersFromUrl(
          'http://api.openweathermap.org/data/2.5/forecast?lat=$lat&lon=$long&lang=$langweb&units=metric&appid=1a19aa6a7226df0fe9fa99a91de215ca');
